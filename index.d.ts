...
declare module 'eris-pagination' {
  ...
  interface PaginationOptions {
    ...
    timeout?: number;
    /** Emoji which should be used as the delete button. Defaults to: 🗑 */
    deleteButton?: string;
    /** Emoji which should be used as the first page button. Defaults to: ⏮ */
    firstButton?: string;
    /** Emoji which should be used as the last page button. Defaults to: ⏭ */
    lastButton?: string;
    /** Emoji which should be used as the back button. Defaults to: ⬅ */
    backButton?: string;
    /** Emoji which should be used as the forth button. Defaults to: ➡ */
    forthButton?: string;
